...
```
const Optist = require('@diotoborg/dolore-sint-deserunt');
...
Pre-made callbacks are available in util module of the @diotoborg/dolore-sint-deserunt package.
...
```
const Optist = require('@diotoborg/dolore-sint-deserunt');
const ou = require('@diotoborg/dolore-sint-deserunt/util');
